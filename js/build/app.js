...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Global = __webpack_require__(301);
	...
	function refreshPage() {
		var words = _Global2.default.words,
		    $contents = _Global2.default.$contents,
		    i = void 0;

		var selectedWords = _Util2.default.randomElementsFromArr(words, $contents.length, false);
...
/***/ function(module, exports) {
	...
	var Global = {
		words: ["의사", "청초", "이성", "질서", "지혜", "서약", "선량", "절도", "성실", "생명", "관용", "해방", "조화", "창조", "신화", "공식", "변화", "결합", "엄격", "용기", "행운", "치유", "자애"],
		$contents: $(".tdContent")
	};
